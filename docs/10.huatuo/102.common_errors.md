...
如何添加AOT泛型实例，参见 [泛型共享原理](./50.%E5%8E%9F%E7%90%86%E4%B8%8E%E7%89%B9%E6%80%A7/34.generic_limit.md) 中的示例

## 遇到 ExecutionEngineException: GetManaged2NativeMethodPointer not support. xxxx 函数名

这是因为这个AOT函数与interpreter之间的桥接函数不存在。请参考 [桥接函数](/huatuo/advance/method_bridge/) 文档进行处理。
