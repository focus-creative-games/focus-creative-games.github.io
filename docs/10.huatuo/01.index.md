...
::: tip 好消息
已经可以在pc平台完整运行重度MMORPG项目, 预计在7月份会有使用huatuo的重度MMORPG项目上线。
:::
...
<table>
   ...
   <td>轻量及小游戏</td>
   		...
   		<td> <a href="https://github.com/EllanJiang/StarForce" target="_blank"> StarForce</a> </td>
        <td>GameT 独立游戏   欢乐斗兽棋 Pizza猫</td>
