...
- For 2019.4.40+, 2021.3.21+, 2021.3.0+ versions, copy the il2cpp file directly from the installation directory of that version.
- For 2020.3.16-2020.3.20 versions, 2020.3.21+ versions need to be installed additionally, because the il2cpp files of these versions are not compatible with HybridCLR, but il2cpp of compatible versions (ie 2020.3.21+) can be used.  **Notice! From version 1.1.7, the installer no longer supports installing il2cpp related files from other versions, you can only install them manually according to the principle.**
