...
- 复制hybridclr_trial项目Packages/com.focus-creative-games.hybridclr_unity到你的项目相应位置。
- 复制hybridclr_trial项目HybridCLRData到你的项目相应位置。
- 复制hybridclr_trial项目`Assets/Editor/HybridCLR`到你们项目
