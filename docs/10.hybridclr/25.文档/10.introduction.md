...
permalink: /hybridclr/introduction/
categories:
    - HybridCLR
tags:
    -
...
自2022.3.33开源以来，已经有数百个大中小型商业游戏项目完成接入，已超过[8个中重度商业项目](/hybridclr/business_games/)Android+iOS双平台正式上线，以及更多项目已经上线对外测试，同时在线上有超过3个月的稳定表现。
