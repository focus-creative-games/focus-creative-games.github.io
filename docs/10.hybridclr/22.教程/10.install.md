...
- 安装 2019.4.40、2020.3.21、2021.3.0或更高版本。新手强烈推荐先用2020.3.33版本熟悉热更新后，再尝试自己项目的版本。如果你安装的hybridclr_unity版本号<=1.1.6，由于Installer使用路径中的版本号来判定Unity版本，请确保安装路径中包含版本号，例如 `d:\Unity2020.3.33`，1.1.7及更高版本移除此限制。
